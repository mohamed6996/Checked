...
import com.todo.checked.archive.Archive;
...
public class AddTaskActivity extends AppCompatActivity implements TimePickerDialog.OnTimeSetListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout adViewContainer = (LinearLayout) findViewById(R.id.adAddTask);

        adView = new AdView(this, "1312538295448755_1313929411976310", AdSize.BANNER_HEIGHT_50);
                        ...
                        .setOnColorSelectedListener(new SpectrumDialog.OnColorSelectedListener() {
                            ...
                            public void onColorSelected(boolean positiveResult, @ColorInt int color) {
                                if (positiveResult) {
                                    ...
                                    //    picked_color.setBackgroundTintList(ColorStateList.valueOf(color));
