...
import com.todo.checked.note.Notes;
import com.todo.checked.settings.Settings;
import com.todo.checked.task.AddTaskActivity;
import com.todo.checked.task.CustomCursorAdapter;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   LinearLayout adViewContainer = (LinearLayout) findViewById(R.id.adMain);
        ...
        ImageView settings = (ImageView) findViewById(R.id.id_settings);
